...
fn generate_new_public_address(mut cx: FunctionContext) -> JsResult<JsObject> {
    ...
    let hasher = sapling_bls12::SAPLING.clone();
    let sapling_key =
        sapling_bls12::Key::from_hex(hasher, &private_key).or_else(|err| cx.throw_error(err.to_string()))?;
...
fn main(mut cx: ModuleContext) -> NeonResult<()> {
    ...
    cx.export_function("noteEncryptedDeserialize", structs::NativeNoteEncrypted::deserialize)?;
    cx.export_function("noteEncryptedSerialize", structs::NativeNoteEncrypted::serialize)?;
    cx.export_function("noteEncryptedEquals", structs::NativeNoteEncrypted::equals)?;
    cx.export_function("noteEncryptedMerkleHash", structs::NativeNoteEncrypted::merkle_hash)?;
    cx.export_function("noteEncryptedDecryptNoteForOwner", structs::NativeNoteEncrypted::decrypt_note_for_owner)?;
    cx.export_function("noteEncryptedDecryptNoteForSpender", structs::NativeNoteEncrypted::decrypt_note_for_spender)?;
    ...
    cx.export_function("simpleTransactionNew", structs::NativeSimpleTransaction::new)?;
    cx.export_function("simpleTransactionSpend", structs::NativeSimpleTransaction::spend)?;
    cx.export_function("simpleTransactionReceive", structs::NativeSimpleTransaction::receive)?;
    cx.export_function("simpleTransactionPost", structs::NativeSimpleTransaction::post)?;
    ...
    cx.export_function("transactionPostMinersFee", structs::NativeTransaction::post_miners_fee)?;
    ...
    cx.export_function("transactionPostedDeserialize", structs::NativeTransactionPosted::deserialize)?;
    cx.export_function("transactionPostedSerialize", structs::NativeTransactionPosted::serialize)?;
    cx.export_function("transactionPostedVerify", structs::NativeTransactionPosted::verify)?;
    cx.export_function("transactionPostedNotesLength", structs::NativeTransactionPosted::notes_length)?;
    cx.export_function("transactionPostedGetNote", structs::NativeTransactionPosted::get_note)?;
    cx.export_function("transactionPostedSpendsLength", structs::NativeTransactionPosted::spends_length)?;
    cx.export_function("transactionPostedGetSpend", structs::NativeTransactionPosted::get_spend)?;
    cx.export_function("transactionPostedTransactionFee", structs::NativeTransactionPosted::transaction_fee)?;
    cx.export_function("transactionPostedTransactionSignature", structs::NativeTransactionPosted::transaction_signature)?;
    cx.export_function("transactionPostedTransactionHash", structs::NativeTransactionPosted::transaction_hash)?;
